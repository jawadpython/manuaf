      ...
      <section className="py-10 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-[#666666]">Fournir des équipements de qualité supérieure</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--accent)] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-[#666666]">Offrir un service client exceptionnel</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--accent)] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-[#666666]">Maintenir des standards de sécurité élevés</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--accent)] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-[#666666]">Proposer des solutions économiques et durables</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 border-t-4 border-[var(--accent)] mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[#333333] mb-6 text-center">
              Nos valeurs
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold text-[#333333] mb-2">Fiabilité</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-[#333333] mb-2">Excellence</h3>
                <p className="text-[#666666] text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-[#333333] mb-2">Proximité</h3>
                <p className="text-[#666666] text-sm">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
                <h3 className="font-bold text-[#333333] mb-3">Vente</h3>
                <p className="text-[#666666] text-sm">
                  Large gamme de chariots élévateurs neufs et d&apos;occasion
                </p>
              </div>
              <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
                <h3 className="font-bold text-[#333333] mb-3">Location</h3>
                <p className="text-[#666666] text-sm">
                  Solutions de location flexibles pour tous vos besoins
                </p>
              </div>
              <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
                <h3 className="font-bold text-[#333333] mb-3">Maintenance</h3>
                <p className="text-[#666666] text-sm">
                  Service de maintenance préventive et curative par des experts
                </p>
              </div>
              <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
                <h3 className="font-bold text-[#333333] mb-3">Pièces</h3>
                <p className="text-[#666666] text-sm">
