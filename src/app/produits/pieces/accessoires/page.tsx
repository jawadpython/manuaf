        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Fourches</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
            ...
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Pinces</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
            ...
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Rotateurs</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
            ...
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Échelles</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
            ...
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Attaches</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
            ...
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-semibold text-[var(--surface-contrast)] mb-3">Autres accessoires</h3>
              <ul className="space-y-2 text-[var(--body-muted)] text-sm">
          ...
          <div className="bg-white p-6 md:p-8 border-t-4 border-[var(--accent)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <h3 className="font-semibold text-[var(--surface-contrast)] mb-2">Qualité garantie</h3>
              ...
              <div>
                ...
                <h3 className="font-semibold text-[var(--surface-contrast)] mb-2">Prix compétitifs</h3>
                <p className="text-[var(--body-muted)] text-sm">
