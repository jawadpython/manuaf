        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              ...
              <h3 className="text-lg font-bold text-[#333333] mb-2">Reconditionnés</h3>
              <p className="text-[#666666] text-sm">
                Tous nos chariots d&apos;occasion sont entièrement reconditionnés et testés
              </p>
            </div>
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              <div className="w-12 h-12 bg-[var(--accent)]/10 rounded-full flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-bold text-[#333333] mb-2">Garantis</h3>
              <p className="text-[#666666] text-sm">
                Garantie incluse sur tous nos équipements d&apos;occasion
              </p>
            </div>
            <div className="bg-white p-6 border-t-4 border-[var(--accent)]">
              <div className="w-12 h-12 bg-[var(--accent)]/10 rounded-full flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-bold text-[#333333] mb-2">Prix réduits</h3>
              <p className="text-[#666666] text-sm">
                Économisez jusqu&apos;à 40% par rapport au neuf, qualité identique
              </p>
            </div>
          </div>
