...
const dashboardCards = [
  ...
  },
  {
    ...
    description: 'Produits /produits/nacelles/occasion',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  },
  {
    ...
    title: 'Nacelles de location',
    description: 'Produits /produits/nacelles/location',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 10l7-7m0 0l7 7m-7-7v18" />
      </svg>
  ...
  {
    href: '/admin/transpalette-manuel',
    title: 'Transpalette manuel',
    description: 'Produits /produits/transpalette-manuel',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
      </svg>
  ...
  },
  {
    ...
    description: 'Toutes les demandes (devis produits, location chariots / nacelles, etc.)',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  return (
    <>
      <header className="mb-8">
        <h1 className="font-display text-base lg:text-lg text-[var(--foreground)] tracking-tight">
          Dashboard
        </h1>
