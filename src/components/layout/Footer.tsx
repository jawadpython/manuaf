...
export function Footer() {
  return (
    <footer>
      {/* Dark grey main section */}
      <div className="bg-[#3C464B]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-2 sm:gap-3">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-white/10 flex items-center justify-center hover:bg-[var(--accent)] transition-colors rounded">
